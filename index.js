...
//     openTrades.forEach(row => {
//       const rowData = [row.type, row.volume.toString(), row.profit.toString()];
//       table.push(rowData);
//       sumProfit += row.profit;
//     });

//     // Add a row for the sum of profits
//     table.push(['Total Profit', '', sumProfit.toFixed(2)]);
...
// async function getTradeHistoryBySymbolAndDate() {
//   try {
//     const start = '2023-01-01'; // Replace with your start date
//     const end = '2023-08-06';   // Replace with your end date
//     const symbol = 'XAUUSD';    // Replace with the desired trading symbol
    
//     const tradeHistory = await metaStats.getAccountTrades(AccountId, start, end);

//     console.log(tradeHistory[0]);
...
//     // tradeHistory['trades'].forEach(row => {
//     //   const rowData = [row.type, row.volume.toString(), row.profit.toString()];
//     //   table.push(rowData);
//     //   sumProfit += row.profit;
//     // });
...
// // Call the functions to retrieve and display trade history
// // getAccountOpenTrades();
// getTradeHistoryBySymbolAndDate();
